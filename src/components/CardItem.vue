<template>
  <div class="card" :style="`box-shadow: 0px 0px 27px 0px ${borderColor}`">
    ...
    <div class="info">
      ...
      <p>
        <b>Рейтинг</b>: {{ props.card.rating ? props.card.rating.rate : 0 }}
      </p>
    </div>
    <CardForm
      ...
      <v-card class="d-flex align-center pa-5">
        ...
        <v-card-actions class="justify-space-between" style="width: 400px">
          <v-btn
            ...
            >Да</v-btn
          >
          <v-btn variant="outlined" @click="isDeleteCardDialogOpen = false"
            >Нет</v-btn
          >
        </v-card-actions>
      </v-card>
