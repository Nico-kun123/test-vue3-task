<template>
  <div class="wrapper">
    <div class="sort__panel">
      <div class="sort__panel__btns">
        <button @click="sortList('ascending')">По возрастанию рейтинга</button>
        <button @click="sortList('descending')">По убыванию рейтинга</button>
        <button @click="sortList('none')">Без сортировки</button>
      </div>
    </div>
    <section
